...
export const ICONS: Record<string, string> = {
  ...
  cloud: `<path d="M7 18.5h10.2a4.3 4.3 0 0 0 .6-8.55A6 6 0 0 0 6.3 9.3 4.6 4.6 0 0 0 7 18.5z" ${D}/><path d="M7 18.5h10.2a4.3 4.3 0 0 0 .6-8.55A6 6 0 0 0 6.3 9.3 4.6 4.6 0 0 0 7 18.5z"/><path d="M12 16v-5M9.8 13.2 12 11l2.2 2.2"/>`,
  ranking: `<rect x="3.5" y="12" width="5" height="8.5" rx="1" ${D}/><rect x="3.5" y="12" width="5" height="8.5" rx="1"/><rect x="9.5" y="6" width="5" height="14.5" rx="1" ${D}/><rect x="9.5" y="6" width="5" height="14.5" rx="1"/><rect x="15.5" y="9.5" width="5" height="11" rx="1"/><path d="M12 2.5l.8 1.6 1.7.2-1.3 1.2.3 1.7-1.5-.8-1.5.8.3-1.7-1.3-1.2 1.7-.2z" ${F}/>`,
